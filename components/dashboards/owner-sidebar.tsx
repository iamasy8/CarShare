...
import { Car, Calendar, DollarSign, Settings, MessageCircle, HelpCircle, LogOut } from "lucide-react"
...
export function OwnerSidebar() {
  ...
  const navItems = [
    { href: "/owner/dashboard", label: "Tableau de bord", icon: Car },
    { href: "/owner/cars", label: "Mes véhicules", icon: Car },
    { href: "/owner/bookings", label: "Réservations", icon: Calendar },
    { href: "/owner/earnings", label: "Revenus", icon: DollarSign },
    { 
      href: "/messages", 
      label: "Messages", 
      icon: MessageCircle,
